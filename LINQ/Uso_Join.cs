...
namespace LINQ
{
    public   class Uso_Join
    {
        ...
        public void GroupJoinEjem()
        {
            ...
            var direccion = new EntAddress().DataAddress();
        ...
        public void InnerJoinCon2Tablas()
        {
            ...
            var dataTrabajador = new EntTrabajador().DataTrabajador();
            var dataAddress = new EntAddress().DataAddress();
        ...
        public void InnerJoinCon3Tablas()
        {
            ...
            var dataTrabajador = new EntTrabajador().DataTrabajador();
            var dataAddress = new EntAddress().DataAddress();
            var dataMark = new EntMarks().DataMarks();
        ...
        public void LeftJoin()
        {
            ...
            var dataTrabajador = new EntTrabajador().DataTrabajador();
            var dataDireccion = new EntAddress().DataAddress();
